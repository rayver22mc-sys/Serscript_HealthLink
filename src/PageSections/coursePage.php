...
<body>
    ...
    <main>
        ...
        <div class="coursesDiv">
            <!-- Course Row 1 -->
            <div>
                <h2>Importance of Physical Activity</h6>
            ...
            <div class="Nutrition">
                <h2>Nutrition Guidelines for Healthy Living</h6>
            ...
            <div class="Nutrition">
                <h2>Balancing Nutrition and Physical Activity</h6>
    ...
    <footer>
        ...
        <div>
            ...
            <a href="mailto:HealthyLivingTeam@gmail.com" style="color: white;">HealthyLivingTeam@gmail.com</a>
                ...
                <h2>Importance of Physical Activity</h2>
                <p>Physical activity is essential for maintaining overall health and preventing disease. The CDC provides guidance on how regular movement improves well-being.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(1)">View Details</button>
                    <a href="https://www.cdc.gov/physicalactivity/" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            ...
            <div class="Nutrition">
                ...
                <p>Nutrition guidelines provide recommendations for maintaining a balanced and healthy diet. The CDC outlines key principles for proper nutrition.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(2)">View Details</button>
                    <a href="https://www.cdc.gov/nutrition/php/guidelines-recommendations/index.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            ...
            <div class="Nutrition">
                ...
                <p>Nutrition and physical activity work together to promote a healthy lifestyle. ODPHP emphasizes the importance of combining both for better health outcomes.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(3)">View Details</button>
                    <a href="https://odphp.health.gov/our-work/nutrition-physical-activity" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            ...
            <div class="HealthCare">
                ...
                <p>A healthy lifestyle includes both proper nutrition and regular fitness. The HHS provides strategies for maintaining overall health and well-being.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(4)">View Details</button>
                    <a href="https://www.hhs.gov/programs/prevention-and-wellness/nutrition-and-fitness/index.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Promoting Wellness Through Nutrition and Activity</h2>
                <p>Nutrition and physical activity are key components of overall wellness. This resource highlights their importance in daily life.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(5)">View Details</button>
                    <a href="https://health.mo.gov/living/wellness/nutrition/nutritionphysicalactivity/index.php" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Achieving a Healthy Weight</h2>
                <p>Maintaining a healthy weight is important for overall health. The CDC explains how nutrition and activity contribute to weight management.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(6)">View Details</button>
                    <a href="https://www.cdc.gov/healthyweight/index.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            ...
            <div>
                ...
                <p>Nutrition guidelines help improve food choices in various settings. The CDC promotes healthier food environments through these standards.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(7)">View Details</button>
                    <a href="https://www.cdc.gov/nutrition/php/public-health-strategy/food-service-and-nutrition-guidelines.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Reliable Nutrition Information</h2>
                <p>Nutrition.gov provides trusted information on healthy eating and nutrition. It serves as a guide for making informed dietary choices.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(8)">View Details</button>
                    <a href="https://www.nutrition.gov" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Understanding Nutrition and Weight Status</h2>
                <p>This resource explains how nutrition and physical activity influence weight and health. The CDC provides key indicators related to these factors.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(9)">View Details</button>
                    <a href="https://www.cdc.gov/cdi/indicator-definitions/npao.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Dietary Guidelines for Healthy Living</h2>
                <p>The Dietary Guidelines provide science-based advice on what to eat for good health. They help individuals make informed food choices.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(10)">View Details</button>
                    <a href="https://www.dietaryguidelines.gov" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            ...
            <div>
                ...
                <p>Sleeping well is essential for maintaining both physical and mental health. The CDC provides guidance on how good sleep habits can improve overall well-being and daily functioning.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(11)">View Details</button>
                    <a href="https://www.cdc.gov/cancer-survivors/healthy-living-guides/sleep.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Understanding the Importance of Sleep</h2>
                <p>Sleep is a basic human need that affects nearly every aspect of health. The CDC explains how sleep supports body functions and why it should be prioritized.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(12)">View Details</button>
                    <a href="https://www.cdc.gov/sleep/about/index.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Sleep Statistics in Adults</h2>
                <p>Sleep data from the CDC highlights how much sleep adults get and its impact on health. These statistics show trends and concerns related to sleep patterns.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(13)">View Details</button>
                    <a href="https://www.cdc.gov/sleep/data-research/facts-stats/adults-sleep-facts-and-stats.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Youth High-Risk Drug Use</h2>
                <p>High-risk drug use among youth can lead to serious health and social consequences. The CDC provides insights into the causes and effects of substance use in young people.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(14)">View Details</button>
                    <a href="https://www.cdc.gov/youth-behavior/risk-behaviors/youth-high-risk-drug-use.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Overdose Prevention and Community Engagement</h2>
                <p>The ENGAGE toolkit supports communities in preventing drug overdoses through collaboration and education. It provides resources for building effective partnerships.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(15)">View Details</button>
                    <a href="https://www.cdc.gov/overdose-prevention/engage/" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Building Drug-Free Communities</h2>
                <p>The Drug-Free Communities program helps reduce substance use through community-driven strategies. It empowers local groups to create safer environments.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(16)">View Details</button>
                    <a href="https://www.cdc.gov/drug-free-communities/" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Mental Health and Substance Use Disorders</h2>
                <p>Co-occurring disorders refer to the presence of both mental health and substance use conditions. SAMHSA explains how these conditions interact and affect individuals.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(17)">View Details</button>
                    <a href="https://www.samhsa.gov/mental-health/what-is-mental-health/conditions/co-occurring-disorders" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Meeting Physical Activity Recommendations</h2>
                <p>Regular physical activity is essential for maintaining good health. The CDC outlines recommended guidelines to help individuals stay active and reduce health risks.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(18)">View Details</button>
                    <a href="https://www.cdc.gov/physical-activity-basics/guidelines/index.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>Incorporating Physical Activity into Daily Life</h2>
                <p>Adding physical activity into a busy schedule can be simple and manageable. The CDC provides practical ways for adults to stay active every day.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(19)">View Details</button>
                    <a href="https://www.cdc.gov/physical-activity-basics/adding-adults/index.html" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
            <div>
                <h2>The Importance of Physical Activity</h2>
                <p>Physical activity plays a key role in improving overall health and preventing diseases. The WHO highlights its global importance for all age groups.</p>
                <span style="display: flex; gap: 10px; justify-content: center; width: 100%;">
                    <button class="learnMoreButton" onclick="togglePopUp(20)">View Details</button>
                    <a href="https://www.who.int/initiatives/behealthy/physical-activity" target="_blank"><button class="learnMoreButton">Learn More</button></a>
                </span>
            </div>
        </div>
